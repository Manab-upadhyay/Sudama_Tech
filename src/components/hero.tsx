...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[250vh] py-32 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
    >
      <Header />
      <motion.div
        style={{
...
export const Header = () => {
  return (
    <div className="max-w-7xl relative mx-auto py-16 md:py-32 px-4 w-full left-0 top-0">
      ...
      <p className="max-w-2xl text-base md:text-lg mt-6 text-neutral-700">
